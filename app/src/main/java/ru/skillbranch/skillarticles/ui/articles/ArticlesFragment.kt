...
class ArticlesFragment : BaseFragment<ArticlesViewModel>() {
    ...
    private lateinit var suggestionsAdapter: SimpleCursorAdapter //адаптер для подсказок нашего searchView
    //для поиска
    ...
    override fun onPrepareOptionsMenu(menu: Menu) { //обработка нажатия на searchView
        ...
        // чтобы подсказки были уже после ввода первого символа
